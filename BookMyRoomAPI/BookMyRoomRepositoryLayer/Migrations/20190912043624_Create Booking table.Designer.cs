...
namespace BookMyRoomRepositoryLayer.Migrations
{
    ...
    [Migration("20190912043624_Create Booking table")]
            ...
            modelBuilder.Entity("BookMyRoomCommonLayer.Entities.BookingEntity", b =>
                {
                    ...
                    b.Property<int?>("UserIdUser_ID");

                    b.HasKey("BookId");

                    b.HasIndex("HotelID");

                    b.HasIndex("UserIdUser_ID");
            ...
            modelBuilder.Entity("BookMyRoomCommonLayer.Entities.BookingEntity", b =>
                {
                    ...
                    b.HasOne("BookMyRoomCommonLayer.Entities.UserProfiles", "UserId")
                        .WithMany()
                        .HasForeignKey("UserIdUser_ID");
                });
