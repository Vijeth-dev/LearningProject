...
namespace BookMyRoomRepositoryLayer.Migrations
{
    ...
    [Migration("20190919050235_booking-foreign-keys")]
    partial class bookingforeignkeys
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookMyRoomCommonLayer.Entities.RoomEntity", b =>
                {
            ...
            modelBuilder.Entity("BookMyRoomCommonLayer.Entities.BookingEntity", b =>
                {
                    b.HasOne("BookMyRoomCommonLayer.Entities.Hotel", "_Hotel")
                        .WithMany()
            ...
            modelBuilder.Entity("BookMyRoomCommonLayer.Entities.RoomEntity", b =>
                {
                    b.HasOne("BookMyRoomCommonLayer.Entities.Hotel", "_HotelId")
                        .WithMany()
                        .HasForeignKey("HotelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
